...
```
> git clone https://github.com/prenato84/fundamentos-nodejs
```
...
O template pode ser encontrado na seguinte url: **[Acessar Template](https://github.com/Rocketseat/gostack-template-fundamentos-node)**
